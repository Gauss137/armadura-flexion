      ...
      <footer className="w-full bg-gray-50 py-4 mt-4 border-t border-gray-200">
        <div className="max-w-4xl mx-auto px-6 text-center text-sm text-gray-600">
          <p className="mt-2 text-xs text-gray-500">
            El contenido de esta página es de acceso libre y gratuito. Si los recursos ofrecidos resultan útiles, es posible colaborar con una contribución voluntaria a través de los siguientes medios. Estos aportes ayudan a mantener y mejorar el desarrollo de nuevos contenidos abiertos.
          </p>
